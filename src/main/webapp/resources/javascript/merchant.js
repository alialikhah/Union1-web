...
function clearInput() {
	...
	document.getElementById("form:merchantSailManagerMobile").value="";
	document.getElementById("form:merchantInterfaceName").value="";
	document.getElementById("form:merchantInterfaceMobile").value="";
	document.getElementById("form:merchantTelegramAddr").value="";
	document.getElementById("form:merchantTelegramNum").value="";
	document.getElementById("form:merchantPhone").value="";
	document.getElementById("form:merchantFax").value="";
	document.getElementById("form:merchantSiteAddres").value="";
	document.getElementById("form:merchantEmail").value="";
	document.getElementById("form:merchantInstagramAddr").value="";
	document.getElementById("form:merchantInstagramNum").value="";
	document.getElementById("form:merchantTwiter").value="";
	document.getElementById("form:merchantWatsup").value="";
