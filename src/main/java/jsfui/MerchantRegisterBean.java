...
public class MerchantRegisterBean implements Serializable {
	...
	//*****************************************Convert Persian To English Calendar**************************************
...
/*	public void saveMessage() {
    ...
    public void updateMerchantEntityName(String merchantId) throws IOException{
    	...
    	FacesContext.getCurrentInstance().getExternalContext().redirect( "merchantedit.xhtml"+"?merchantID=" + merchantId );
    }
    ...
    public void updateMerchantEntityUserName(String merchantId) throws IOException{
    	FacesContext context = FacesContext.getCurrentInstance();
    	MerchantEntity merchantEntity=new MerchantEntity();
    	long id=Long.parseLong(merchantId);
    	merchantEntity=this.findMerchantById(id);
...
// *********************************************************English to Persian Calendar******************************
    ...
    public String convertToJalali2(String merchantId) {
    	...
    	long id=Long.parseLong(merchantId);
    	merchantEntity=this.findMerchantById(id);
    	String dateEng=merchantEntity.getMerchantKhateme().toString();
    	System.err.println(dateEng);
    	char[] mnth=new char[3];
    	dateEng.getChars(4,7,mnth, 0);
    	String month="";
    ...
    public String convertToJalali3(String merchantId) {
    	...
    	long id=Long.parseLong(merchantId);
    	merchantEntity=this.findMerchantById(id);
    	String dateEng=merchantEntity.getMerchantMobasherDate().toString();
    	System.err.println(dateEng);
    	char[] mnth=new char[3];
    	dateEng.getChars(4,7,mnth, 0);
    	String month="";
...
/*    public MerchantEntity findMerchantByShomareParvande(){
    	FacesContext context = FacesContext.getCurrentInstance();
    	
    		return merchantRegisterServiceLocal.findMerchantByShomareParvande(searchShomareParvande);		
...
/*    public String findShomareParAndGoPage() {
   	 return "merchantedit.xhtml?merchantID="+ findMerchantByShomareParvande().getMerchantId() + "&faces-redirect=true";
   }*/
